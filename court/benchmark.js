...
const runTests = async () => {
    ...
    document.querySelector(".test-basic .no-sort-results").innerText = `Implementation 3 (best optimized): ${benchmark(courtNoSort, tests)} ms/iteration`;
    ...
    document.querySelector(".test-50 .no-sort-results").innerText = `Implementation 3 (best optimized): ${benchmark(courtNoSort, tests)} ms/iteration`;
    ...
    document.querySelector(".test-100 .no-sort-results").innerText = `Implementation 3 (best optimized): ${benchmark(courtNoSort, tests)} ms/iteration`;
